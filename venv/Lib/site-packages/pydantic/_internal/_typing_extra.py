...
def is_classvar(tp: Any, /) -> bool:
    ...
    which is used to check if an annotation (in the context of a Pydantic models or dataclass)
...
def get_model_type_hints(
    ...
    *,
    ...
    """Collect annotations from a Pydantic models class, including those from parent classes.

    Args:
        obj: The Pydantic models to inspect.
