...
class NsResolver:
    ...
    Example:
        ...
        with ns_resolver.push(Model):
            ...
            # First thing to notice here, the models being pushed is added to the locals.
            # Because `NsResolver` is being used during the models definition, it is not
            ...
            with ns_resolver.push(Sub):
                ...
                # This is not an issue, just that as described above, the models being pushed
