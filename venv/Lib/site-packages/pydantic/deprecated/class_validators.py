    ...
    *fields: str,
    ...
    Args:
        ...
        *fields (str): Additional field(s) the validator should be called on.
        ...
        check_fields (bool | None, optional): Whether to check that the fields actually exist on the models.
            Defaults to None.
...
def root_validator(
    *__args,
    ...
    """Decorate methods on a models indicating that they should be used to validate (and perhaps
    modify) data either before or after standard models parsing/validation is performed.
