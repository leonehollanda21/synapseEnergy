...
def get_subcommand(
    ...
    """
    Get the subcommand from a models.

    Args:
        model: The models to get the subcommand from.
        is_required: Determines whether a models must have subcommand set and raises error if not
            found. Defaults to `True`.
        cli_exit_on_error: Determines whether this function exits with error if no subcommand is found.
            Defaults to model_config `cli_exit_on_error` value if set. Otherwise, defaults to `True`.

    Returns:
        The subcommand models if found, otherwise `None`.
...
class PydanticBaseSettingsSource(ABC):
    ...
    def get_field_value(self, field: FieldInfo, field_name: str) -> tuple[Any, str, bool]:
        """
        Gets the value, the key for models creation, and a flag to determine whether value is complex.
...
class DefaultSettingsSource(PydanticBaseSettingsSource):
    ...
    Args:
        ...
        nested_model_default_partial_update: Whether to allow partial updates on nested models default object fields.
            Defaults to `False`.
    """
...
class PydanticBaseEnvSettingsSource(PydanticBaseSettingsSource):
    ...
    def _extract_field_info(self, field: FieldInfo, field_name: str) -> list[tuple[str, str, bool]]:
        ...
        It returns a list of tuples, each tuple contains:
            * field_key: The key of field that has to be used in models creation.
    ...
    def _replace_field_names_case_insensitively(self, field: FieldInfo, field_values: dict[str, Any]) -> dict[str, Any]:
        ...
        for name, value in field_values.items():
            ...
            # Find field in sub models by looking in fields case insensitively
    ...
    def _get_resolved_field_value(self, field: FieldInfo, field_name: str) -> tuple[Any, str, bool]:
        """
        Gets the value, the preferred alias key for models creation, and a flag to determine whether value
        is complex.
...
class EnvSettingsSource(PydanticBaseEnvSettingsSource):
    ...
    def next_field(
        ...
        """
        Find the field in a sub models by key(env name)
...
class CliSettingsSource(EnvSettingsSource, Generic[T]):
    ...
    def _add_parser_args(
        ...
        # Ignore models default if the default is a models and not a subclass of the current models.
        model_default = (
            None
            if (
...
def _annotation_is_complex(annotation: type[Any] | None, metadata: list[Any]) -> bool:
    # If the models is a root models, the root annotation should be used to
