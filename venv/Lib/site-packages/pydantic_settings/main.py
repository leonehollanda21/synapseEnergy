...
# to extract config keys from models kwargs, So, by adding pydantic settings keys to
...
class BaseSettings(BaseModel):
    ...
    Args:
        _case_sensitive: Whether environment and CLI variable names should be read with case-sensitivity.
            Defaults to `None`.
        _nested_model_default_partial_update: Whether to allow partial updates on nested models default object fields.
            Defaults to `False`.
...
class CliApp:
    ...
    def run(
        ...
        **model_init_data: Any,
        ...
        Running a models as a CLI application requires the `cli_cmd` method to be defined in the models class.

        Args:
            model_cls: The models class to run as a CLI application.
            ...
            cli_settings_source: Override the default CLI settings source with a user defined instance.
                Defaults to `None`.
            cli_exit_on_error: Determines whether this function exits on error. If models is subclass of
            ...
            model_init_data: The models init data.

        Returns:
            The ran instance of models.
    ...
    def run_subcommand(
        ...
        """
        Runs the models subcommand. Running a models subcommand requires the `cli_cmd` method to be defined in
        the nested models subcommand class.

        Args:
            model: The models to run the subcommand from.
            cli_exit_on_error: Determines whether this function exits with error if no subcommand is found.
                Defaults to model_config `cli_exit_on_error` value if set. Otherwise, defaults to `True`.
            cli_cmd_method_name: The CLI command method name to run. Defaults to "cli_cmd".

        Returns:
            The ran subcommand models.
