...
def model_schema(
    ...
    *,
    ...
    Args:
        ...
        generic_origin: The origin type used for this models, if it's a parametrized generic. Ex,
            if this models schema represents `SomeModel[int]`, generic_origin is `SomeModel`
    ...
    *,
    ...
    Args:
        ...
        generic_origin: The origin type used for this dataclass, if it's a parametrized generic. Ex,
            if this models schema represents `SomeDataclass[int]`, generic_origin is `SomeDataclass`
