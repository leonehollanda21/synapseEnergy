...
class SPANDATA:
    ...
    References or sources cited by the AI models in its response.
    ...
    Documents or content chunks used as context for the AI models.
    ...
    The reason why the models stopped generating.
    Example: "length"
    """
    ...
    For an AI models call, the function that was called. This is deprecated for OpenAI, and replaced by tool_calls
    """
    ...
    For an AI models call, the logit bias
    """
    ...
    The unique descriptor of the models being executed.
    Example: gpt-4
    """
    ...
    For an AI models call, the preamble parameter.
    Preambles are a part of the prompt used to adjust the models's overall behavior and conversation style.
    ...
    For an AI models call, the format of the response
    """
    ...
    The responses to an AI models call. Always as a list.
    Example: ["hello", "world"]
    """
    ...
    Boolean indicating if the models needs to perform a search.
    Example: true
    """
    ...
    Whether or not the AI models call's response was streamed back asynchronously
    Example: true
    """
    ...
    For an AI models call, the temperature parameter. Temperature essentially means how random the output will be.
    Example: 0.5
    """
    ...
    Raw text inputs provided to the models.
    ...
    For an AI models call, the top_k parameter. Top_k essentially controls how random the output will be.
    Example: 35
    """
    ...
    For an AI models call, the top_p parameter. Top_p essentially controls how random the output will be.
    Example: 0.5
    """
    ...
    For an AI models call, the functions that are available
    """
    ...
    Warning messages generated during models execution.
    ...
    GEN_AI_RESPONSE_MODEL = "gen_ai.response.models"
    """
    Exact models identifier used to generate the response
    ...
    """
    The messages passed to the models. The "content" can be a string or an array of objects.
    ...
    GEN_AI_REQUEST_MODEL = "gen_ai.request.models"
    """
    The models identifier being used for the request.
    Example: "gpt-4-turbo"
    """
    ...
    """
    Limits the models to only consider the K most likely next tokens, where K is an integer (e.g., top_k=20 means only the 20 highest probability tokens are considered).
    Example: 35
    """
    ...
    """
    The user message passed to the models.
