...
def _create_get_model_wrapper(original_get_model):
    ...
    """
    Wraps the agents.Runner._get_model method to wrap the get_response method of the models to create a AI client span.
    """
    ...
    def wrapped_get_model(cls, agent, run_config):
        ...
        # Wrap _fetch_response if it exists (for OpenAI models) to capture raw response models
