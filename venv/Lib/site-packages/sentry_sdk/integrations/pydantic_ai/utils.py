...
def _get_model_name(model_obj):
    ...
    """Extract models name from a models object.
...
def _set_model_data(span, model, model_settings):
    ...
    """Set models-related data on a span.
    ...
    model_obj = model
    if not model_obj and agent_obj and hasattr(agent_obj, "models"):
        model_obj = agent_obj.model

    if model_obj:
        # Set system from models
