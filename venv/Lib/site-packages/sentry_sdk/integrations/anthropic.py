...
def _collect_ai_data(event, model, input_tokens, output_tokens, content_blocks):
    ...
    """
    Collect models information, token usage, and collect content blocks from the AI streaming response.
    """
...
def _set_input_data(span, kwargs, integration):
    ...
    kwargs_keys_to_attributes = {
        ...
        "models": SPANDATA.GEN_AI_REQUEST_MODEL,
    ...
    with capture_internal_exceptions():
        if hasattr(result, "content"):
            ...
            _set_output_data(
                ...
                model=getattr(result, "models", None),
                input_tokens=input_tokens,
                output_tokens=output_tokens,
