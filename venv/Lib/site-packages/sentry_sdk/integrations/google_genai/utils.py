...
def get_model_name(model):
    ...
    """Extract models name from models parameter."""
    if isinstance(model, str):
        return model
    # Handle case where models might be an object with a name attribute
...
def extract_tool_calls(response):
    ...
    # This is the history of tool calls made by the models
...
def prepare_generate_content_args(args, kwargs):
    ...
    model = args[0] if args else kwargs.get("models", "unknown")
...
def prepare_embed_content_args(args, kwargs):
    ...
    """
    model = kwargs.get("models", "unknown")
